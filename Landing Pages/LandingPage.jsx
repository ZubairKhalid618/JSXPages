const LandingPage = () => {
  const toggleMenu = () => {
    for (let i = 0; i < navToggle.length; i++) {
      navToggle.item(i).classNameList.toggle("hidden");
    }
  };
  ...
  return (
    <div>
      ...
      <div className="relative w-full h-[320px]" id="home">
        ...
        <div className="absolute inset-20 flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 mb-4 md:mb-0">
            <h1 className="text-grey-700 font-medium text-4xl md:text-5xl leading-tight mb-2">
              Bappa Flour mill
            </h1>
            <span className="font-regular text-xl mb-8 mt-4">
              One stop solution for flour grinding services
            </span>
            <a
              href="#contactUs"
              className="px-6 py-3 bg-[#23802b] text-white font-medium rounded-full hover:bg-[#c09858]  transition duration-200"
            >
              Contact Us
            </a>
          </div>
      ...
      <section className="bg-gray-100">
        <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:py-20 lg:px-8">
          <div className="max-w-2xl lg:max-w-4xl mx-auto text-center">
            ...
            <span className="mt-3 text-lg text-gray-500">
              ...
              <div>
                <div className="max-w-full mx-auto rounded-lg overflow-hidden">
                  <div className="border-t border-gray-200 px-6 py-4">
                    ...
                    <span className="mt-1 font-bold text-gray-600">
