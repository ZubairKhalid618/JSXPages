          ...
          <div className="grow">
            <div className="flex flex-col md:flex-row md:justify-end md:items-center gap-0.5 md:gap-1">
              ...
              <div className="hs-dropdown [--strategy:static] md:[--strategy:absolute] [--adaptive:none] [--is-collapse:true] md:[--is-collapse:false] ">
                <button id="hs-header-base-mega-menu-medium" type="button" className="hs-dropdown-toggle w-full p-2 flex items-center text-sm text-gray-800 hover:bg-gray-100 rounded-lg focus:outline-none focus:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" aria-haspopup="menu" aria-expanded="false" aria-label="Mega Menu">
                  ...
                  <div className="md:mx-6 lg:mx-8 md:bg-white md:rounded-lg md:shadow-md dark:md:bg-neutral-800">
                    ...
                    <div className="pt-2 md:pt-0 grid grid-cols-1 md:grid-cols-5 gap-3 md:gap-0">
                      <div className="col-span-3 md:p-3">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-1">
                          <div>
                            <div className="flex flex-col">
                              <div className="space-y-0.5">
                                <span className="ms-2.5 mb-2 font-semibold text-xs uppercase text-gray-800 dark:text-neutral-200">About us</span>

                                {/* Link */}
                                <a className="p-2 flex gap-x-3 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-lg dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" href="/">
                                  <svg className="shrink-0 size-4 mt-0.5 text-gray-800 dark:text-neutral-200" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>
                                  <div className="grow">
                                    <p className="text-sm text-gray-800 dark:text-neutral-200">Support Docs</p>
                                  </div>
                                </a>
                                {/* End Link */}
                                ...
                                <a className="p-2 flex gap-x-3 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-lg dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" href="/">
                                  ...
                                  <div className="grow">
                                    <p className="text-sm text-gray-800 dark:text-neutral-200">Integrations</p>
                                  </div>
                                </a>
                                {/* End Link */}
                                ...
                                <a className="p-2 flex gap-x-3 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-lg dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" href="/">
                                  ...
                                  <div className="grow">
                                    <p className="text-sm text-gray-800 dark:text-neutral-200">Guides</p>
                                  </div>
                                </a>
                                {/* End Link */}
                                ...
                                <a className="p-2 flex gap-x-3 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-lg dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" href="/">
                                  ...
                                  <div className="grow">
                                    <p className="text-sm text-gray-800 dark:text-neutral-200">API Reference</p>
                                  </div>
                                </a>
                                {/* End Link */}
                                ...
                                {/* Link */}
                                <a className="p-2 flex gap-x-3 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-lg dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" href="/">
                                  <svg className="shrink-0 size-4 mt-0.5 text-gray-800 dark:text-neutral-200" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>
                                  <div className="grow">
                                    <p className="text-sm text-gray-800 dark:text-neutral-200">API Status</p>
                                  </div>
                                </a>
                                {/* End Link */}
                              </div>
                          ...
                          <div>
                            <div className="flex flex-col">
                              <div className="space-y-0.5">
                                <span className="ms-2.5 mb-2 font-semibold text-xs uppercase text-gray-800 dark:text-neutral-200">Support</span>
                                ...
                                <a className="p-2 flex gap-x-3 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-lg dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" href="/">
                                  ...
                                  <div className="grow">
                                    <p className="text-sm text-gray-800 dark:text-neutral-200">Help Center</p>
                                  </div>
                                </a>
                                {/* End Link */}
                                ...
                                {/* Link */}
                                <a className="p-2 flex gap-x-3 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-lg dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" href="/">
                                  <svg className="shrink-0 size-4 mt-0.5 text-gray-800 dark:text-neutral-200" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="4"/><path d="M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-4 8"/></svg>
                                  <div className="grow">
                                    <p className="text-sm text-gray-800 dark:text-neutral-200">Developer Hub</p>
                                  </div>
                                </a>
                                {/* End Link */}
                                ...
                                <a className="p-2 flex gap-x-3 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-lg dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" href="/">
                                  ...
                                  <div className="grow">
                                    <p className="text-sm text-gray-800 dark:text-neutral-200">Community Forum</p>
                                  </div>
                                </a>
                                {/* End Link */}
                              </div>
                              ...
                              <div className="mt-3 md:mt-7 space-y-0.5">
                                <span className="ms-2.5 mb-2 font-semibold text-xs uppercase text-gray-800 dark:text-neutral-200">Partners</span>
                                ...
                                <a className="p-2 flex gap-x-3 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-lg dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" href="/">
                                  ...
                                  <div className="grow">
                                    <p className="text-sm text-gray-800 dark:text-neutral-200">Become a Partner</p>
                                  </div>
                                </a>
                                {/* End Link */}
                                ...
                                <a className="p-2 flex gap-x-3 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-lg dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" href="/">
                                  ...
                                  <div className="grow">
                                    <p className="text-sm text-gray-800 dark:text-neutral-200">Build on Preline</p>
                                  </div>
                                </a>
                                {/* End Link */}
                              </div>
                      ...
                      <div className="md:col-span-2">
                        <div className="p-2 md:p-4 md:h-full md:flex-1 flex flex-col md:bg-gray-50 md:rounded-br-lg dark:md:bg-neutral-700">
                          <span className="mb-2 font-semibold text-xs uppercase text-gray-800 dark:text-neutral-200">Customer stories</span>
                          ...
                          <a className="group flex flex-row items-center md:items-start md:flex-col gap-4 md:gap-2 focus:outline-none" href="/">
                            ...
                            <div className="grow">
                              <p className="text-sm text-gray-800 dark:text-neutral-200">Preline Projects has proved to be most efficient cloud based project tracking and bug tracking tool.</p>
