...
<header className="flex flex-wrap md:flex-col md:justify-start md:flex-nowrap z-50 w-full bg-white border-b border-gray-200 dark:bg-neutral-800 dark:border-neutral-700">
  ...
  <div className="max-w-[85rem] mx-auto w-full px-4 sm:px-6 lg:px-8">
    <div className="flex-1 flex items-center justify-end gap-x-3 pt-2">
      <a className="inline-flex justify-center items-center gap-x-2 font-medium text-[12px] text-gray-800 hover:text-neutral-500 focus:outline-none focus:text-neutral-500 dark:text-neutral-200 dark:hover:text-neutral-500 dark:focus:text-neutral-500" href="/">
      ...
      <div className="flex flex-wrap items-center gap-x-1.5">
        <a className="py-[7px] px-2.5 inline-flex items-center font-medium text-[12px] rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 focus:outline-none focus:bg-gray-100 dark:border-neutral-700 dark:text-neutral-300 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" href="/">
          Sign in
        </a>
        <a className="py-2 px-2.5 inline-flex items-center font-medium text-[12px] rounded-lg bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:bg-blue-600" href="/">
          Get started
        </a>
      </div>
      {/* End Button Group */}
