...
const BannerC_6 = () => {
  ...
  {/* Card */}
  <div className="p-4 sm:p-6 bg-white border border-gray-200 shadow-sm dark:bg-neutral-900 dark:border-neutral-800">
      ...
      <div className="grid lg:grid-cols-4 xl:grid-cols-5 gap-5 items-center">
        <div className="col-span-1">
          <a href="../index.html" className="flex-none inline-block">
            <svg className="w-32 md:w-40 h-auto" width="116" height="32" viewBox="0 0 116 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="lg:col-span-3">
          ...
          <div className="mt-5 flex flex-col md:flex-row md:items-center gap-3">
            <div className="flex items-center justify-between md:justify-start w-full">
              <label htmlFor="hs-cookies-necessary" className="md:order-2 text-sm text-gray-500 md:ms-3 dark:text-neutral-400">Necessary</label>
              <input type="checkbox" id="hs-cookies-necessary" className="relative w-[3.25rem] h-7 bg-gray-100 checked:bg-none checked:bg-blue-600 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 ring-1 ring-transparent focus:border-blue-600 focus:ring-blue-600 ring-offset-white focus:outline-none appearance-none  dark:bg-neutral-700 dark:checked:bg-blue-600 dark:focus:ring-offset-gray-800
            ...
            <div className="flex items-center justify-between md:justify-start w-full">
              <label htmlFor="hs-cookies-preferences" className="md:order-2 text-sm text-gray-500 md:ms-3 dark:text-neutral-400">Preferences</label>
              <input type="checkbox" id="hs-cookies-preferences" className="relative w-[3.25rem] h-7 bg-gray-100 checked:bg-none checked:bg-blue-600 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 ring-1 ring-transparent focus:border-blue-600 focus:ring-blue-600 ring-offset-white focus:outline-none appearance-none  dark:bg-neutral-700 dark:checked:bg-blue-600 dark:focus:ring-offset-gray-800

              before:inline-block before:size-6 before:bg-white checked:before:bg-blue-200 before:translate-x-0 checked:before:translate-x-full before:shadow before:rounded-full before:transform before:ring-0 before:transition before:ease-in-out before:duration-200 dark:before:bg-neutral-400 dark:checked:before:bg-blue-200" />
            </div>

            <div className="flex items-center justify-between md:justify-start w-full">
              <label htmlFor="hs-cookies-statistics" className="md:order-2 text-sm text-gray-500 md:ms-3 dark:text-neutral-400">Statistics</label>
              <input type="checkbox" id="hs-cookies-statistics" className="relative w-[3.25rem] h-7 bg-gray-100 checked:bg-none checked:bg-blue-600 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 ring-1 ring-transparent focus:border-blue-600 focus:ring-blue-600 ring-offset-white focus:outline-none appearance-none  dark:bg-neutral-700 dark:checked:bg-blue-600 dark:focus:ring-offset-gray-800

              before:inline-block before:size-6 before:bg-white checked:before:bg-blue-200 before:translate-x-0 checked:before:translate-x-full before:shadow before:rounded-full before:transform before:ring-0 before:transition before:ease-in-out before:duration-200 dark:before:bg-neutral-400 dark:checked:before:bg-blue-200" />
            </div>

            <div className="flex items-center justify-between md:justify-start w-full">
              <label htmlFor="hs-cookies-marketing" className="md:order-2 text-sm text-gray-500 md:ms-3 dark:text-neutral-400">Marketing</label>
              <input type="checkbox" id="hs-cookies-marketing" className="relative w-[3.25rem] h-7 bg-gray-100 checked:bg-none checked:bg-blue-600 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 ring-1 ring-transparent focus:border-blue-600 focus:ring-blue-600 ring-offset-white focus:outline-none appearance-none  dark:bg-neutral-700 dark:checked:bg-blue-600 dark:focus:ring-offset-gray-800
        ...
        <div className="col-span-full col-start-2 xl:col-start-5 xl:col-span-1">
          <div className="grid sm:grid-cols-3 xl:grid-cols-1 gap-y-2 sm:gap-y-0 sm:gap-x-5 xl:gap-y-2 xl:gap-x-0">
            <button type="button" className="py-2 px-3 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
              Allow all
            </button>
