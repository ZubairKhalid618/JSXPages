...
const BannerC_7 = () => {
  ...
  <div className="p-4 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-neutral-900 dark:border-neutral-800">
    <div className="flex gap-x-4">
      <svg className="shrink-0 w-8 h-auto" width="72" height="63" viewBox="0 0 72 63" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="grow">
        <p className="text-sm text-gray-800 dark:text-neutral-200">
          By browsing this website, you accept our <a className="inline-flex items-center gap-x-1.5 text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium dark:text-blue-500" href="/">Cookies Policy</a>
        </p>
      </div>
