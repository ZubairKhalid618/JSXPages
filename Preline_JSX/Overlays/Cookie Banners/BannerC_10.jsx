...
const BannerC_10 = () => {
  ...
  <div className="bg-white rounded-xl shadow-2xl dark:bg-neutral-900 dark:shadow-black/70">
    ...
    <div className="p-4 md:px-6">
      <div className="flex justify-between items-center">
        <svg className="size-8" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M1 26V13C1 6.37258 6.37258 1 13 1C19.6274 1 25 6.37258 25 13C25 19.6274 19.6274 25 13 25H12" stroke="currentColor" strokeWidth="2" className="stroke-blue-600 dark:stroke-white"/>
          <path d="M5 26V13.16C5 8.65336 8.58172 5 13 5C17.4183 5 21 8.65336 21 13.16C21 17.6666 17.4183 21.32 13 21.32H12" stroke="currentColor" strokeWidth="2" className="stroke-blue-600 dark:stroke-white"/>
          <circle cx="13" cy="13.0214" r="5" fill="currentColor" className="fill-blue-600 dark:fill-white"/>
        </svg>

        <select className="py-2 ps-3 pe-8 block cursor-pointer border-gray-200 rounded-lg text-sm hover:bg-gray-50 focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400">
    ...
    {/* Body */}
    <div className="p-4 md:p-6 h-[70vh] sm:h-[65vh] bg-gray-50 border-y border-gray-200 flex flex-col overflow-x-hidden overflow-y-auto dark:bg-neutral-900 dark:border-neutral-800">
