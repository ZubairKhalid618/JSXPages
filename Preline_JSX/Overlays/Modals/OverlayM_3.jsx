...
<div id="hs-cookies" className="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto" role="dialog" tabIndex={-1} aria-labelledby="hs-cookies-label">
    ...
    <div className="relative flex flex-col bg-white shadow-lg rounded-xl dark:bg-neutral-900">
      ...
      <div className="p-4 sm:p-14 text-center overflow-y-auto">
        <svg className="mb-4 w-20 h-auto mx-auto" width="72" height="63" viewBox="0 0 72 63" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M15.5174 56.1528C16.2903 57.6825 16.929 61.4559 14.8118 60.9459C13.5013 60.5381 11.4445 57.6213 12.493 56.1528C12.661 55.8468 13.2189 55.2757 14.106 55.4389" className="stroke-gray-800 dark:stroke-neutral-200" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
          <path d="M15.5173 49.6263L14.0262 48.5579C13.5346 48.2056 12.8477 48.3707 12.658 48.945C12.3456 49.8907 12.1258 51.1463 12.462 52.2324C12.5336 52.4636 12.7127 52.6466 12.9449 52.7146C13.8342 52.9751 15.2568 52.9048 15.8197 51.054" className="stroke-gray-800 dark:stroke-neutral-200" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
          ...
          <path d="M5.84142 38.4394C6.04192 37.9521 6.60952 37.6975 7.12756 37.9156L5.60564 41.6147C7.15177 42.2656 8.89966 41.5188 9.52804 39.9915L5.84142 38.4394ZM7.12756 37.9156C7.6456 38.1337 7.86701 38.7205 7.66651 39.2078L3.9799 37.6557C3.35152 39.1831 4.05951 40.9638 5.60564 41.6147L7.12756 37.9156ZM7.66651 39.2078C7.46601 39.6951 6.89842 39.9498 6.38037 39.7317L7.90229 36.0325C6.35616 35.3816 4.60827 36.1284 3.9799 37.6557L7.66651 39.2078ZM6.38037 39.7317C5.86233 39.5136 5.64092 38.9268 5.84142 38.4394L9.52804 39.9915C10.1564 38.4642 9.44843 36.6834 7.90229 36.0325L6.38037 39.7317Z" className="fill-gray-800 dark:fill-neutral-200" fill="currentColor" mask="url(#path-7-inside-3_4542_101166)"/>
          <path d="M31.6479 50.2383C31.5807 51.2241 32.1721 53.053 35.0756 52.4819" className="stroke-gray-800 dark:stroke-neutral-200" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
          <path d="M50.9903 34.6769C50.1699 34.1428 48.3973 33.5907 47.8709 35.6552" className="stroke-gray-800 dark:stroke-neutral-200" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
          <path d="M40.9087 17.4562C40.0882 16.9221 38.3156 16.37 37.7892 18.4345" className="stroke-gray-800 dark:stroke-neutral-200" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
          <path d="M27.8502 29.3345C27.1279 29.998 26.1419 31.587 27.977 32.6357" className="stroke-gray-800 dark:stroke-neutral-200" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
          <path d="M62.1917 19.585C62.4894 18.6451 62.5577 16.7703 60.4502 16.7902" className="stroke-gray-800 dark:stroke-neutral-200" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
          <ellipse cx="51.2061" cy="22.3973" rx="3.02446" ry="3.05945" className="fill-gray-800 dark:fill-neutral-200" fill="currentColor"/>
          <path d="M67.7398 29.6361C68.8249 31.2826 67.6381 32.6215 66.8281 33.1457C66.7645 33.1869 66.695 33.2184 66.6214 33.2363C65.0504 33.618 63.6063 31.5388 63.6063 30.0441C63.6064 28.8034 66.3283 27.4945 67.7398 29.6361Z" className="fill-gray-800 dark:fill-neutral-200" fill="currentColor"/>
          <path d="M58.868 38.6126C57.9809 36.4914 54.6002 37.7288 53.0207 38.6126C51.7101 39.2284 52.0126 41.4681 53.6256 43.3038C54.9161 44.7723 56.5157 44.1196 57.1542 43.6097C58.0951 42.8279 59.7552 40.7339 58.868 38.6126Z" className="fill-gray-800 dark:fill-neutral-200" fill="currentColor"/>
          <path d="M5.85665 41.8048C5.21042 40.2694 2.74791 41.1651 1.59743 41.8048C0.642774 42.2505 0.863078 43.8717 2.03804 45.2004C2.978 46.2634 4.14317 45.7909 4.60826 45.4219C5.29365 44.8559 6.50288 43.3402 5.85665 41.8048Z" className="stroke-gray-800 dark:stroke-neutral-200" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
          <path d="M45.4596 49.2172C40.9431 47.667 40.2844 51.6987 40.5196 53.9083C40.8221 55.3361 42.4351 55.54 43.4433 55.2341C45.5677 54.5894 51.1052 51.1548 45.4596 49.2172Z" className="fill-gray-800 dark:fill-neutral-200" fill="currentColor"/>
          <ellipse rx="2.96295" ry="3.45694" transform="matrix(0.855131 0.518411 -0.509711 0.860345 30.4996 41.3871)" className="fill-gray-800 dark:fill-neutral-200" fill="currentColor"/>
          <path d="M38.5032 29.1282C39.471 27.8228 37.8983 26.0687 36.991 25.3549C36.0836 24.6411 34.8335 24.8654 33.8657 26.1707C32.7567 27.6664 37.2934 30.7599 38.5032 29.1282Z" className="fill-gray-800 dark:fill-neutral-200" fill="currentColor"/>
          <path d="M19.2476 18.9295C16.4247 18.2768 15.7862 19.8813 15.8198 20.7652C16.0215 23.8246 20.5582 24.4365 21.6672 23.6207C22.4364 23.0548 22.7761 19.7453 19.2476 18.9295Z" className="fill-gray-800 dark:fill-neutral-200" fill="currentColor"/>
          <path d="M36.6888 6.79381C35.6403 4.67259 33.2947 5.02613 32.2529 5.46805C28.7042 6.61025 29.3292 8.52749 30.1358 9.13938C31.3456 10.1252 34.2289 12.0153 36.0839 11.6889C38.4027 11.281 37.9994 9.44533 36.6888 6.79381Z" className="fill-gray-800 dark:fill-neutral-200" fill="currentColor"/>
          <path d="M56.9526 54.9284C57.7592 53.5006 60.2795 51.0735 65.1187 49.9313C66.0596 49.7953 67.9818 48.5647 68.1431 44.7302C68.3448 39.9371 73.5872 32.9003 69.3529 28.1072C67.5382 26.053 68.4456 23.2121 67.5382 17.7051" className="stroke-gray-800 dark:stroke-neutral-200" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
          <path d="M66.7316 16.176C65.1521 14.2383 60.6625 9.8939 55.3394 8.01743C48.703 5.67797 55.8063 4.55591 44.1399 4.75246C44.0816 4.75344 44.0194 4.76029 43.9617 4.76836C43.019 4.90008 40.5102 4.51266 37.2614 1.95295C37.2161 1.91728 37.1681 1.88406 37.1153 1.86091C36.6 1.63502 35.1744 1.43154 32.9584 2.2045C30.6195 3.02036 24.0531 5.46791 21.0622 6.58971C20.4237 6.92965 19.0056 8.05825 18.441 9.85312C17.7353 12.0967 5.93991 23.5187 9.56927 28.9237" className="stroke-gray-800 dark:stroke-neutral-200" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
          <path d="M10.4768 30.1484C11.9084 30.3333 14.621 31.3895 15.0562 34.1372C15.1369 34.6464 15.5068 35.0847 16.0079 35.2063C18.8253 35.8904 22.6446 38.4014 20.8122 44.4603C20.7218 44.7592 20.7652 45.0847 20.9158 45.3583C21.7327 46.8422 22.367 49.4462 20.6725 51.7386C20.1262 52.4776 20.4167 53.842 21.2912 54.1243C23.3727 54.7962 25.8398 55.985 27.2662 57.833C27.5533 58.2049 28.0338 58.3932 28.4956 58.3062C30.4142 57.9446 33.9492 57.9776 37.2937 60.233C42.1328 63.4964 42.3345 60.0291 48.6858 60.7429C53.7669 61.314 55.7765 58.3294 56.1462 56.7656" className="stroke-gray-800 dark:stroke-neutral-200" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
        </svg>
