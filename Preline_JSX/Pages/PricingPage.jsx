  ...
  <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
    ...
    <div>
      ...
      <div className="mt-3 grid space-y-3 text-sm">
        ...
        <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200" href="/">Careers</a> <span className="inline text-violet-600 dark:text-violet-500">— We're hiring</span></p>
    ...
    <div>
      ...
      <div className="mt-3 grid space-y-3 text-sm">
        ...
        <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200" href="/">Status</a></p>
        <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200" href="/">GitHub</a> <span className="inline text-violet-600 dark:text-violet-500">— New</span></p>
      </div>
